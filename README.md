...
## Descripción:
Aplicación de consola desarrollada íntegramente en **Java Vanilla** (sin frameworks). Este proyecto implementa la lógica central de negocio para un sistema de gestión de e-commerce, carritos de compra y facturación.
